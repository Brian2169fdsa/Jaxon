...
export const services = [
  {
    ...
    description: "Consistent mowing, trimming, edging, and cleanup on a schedule that keeps your property sharp.",
    included: [
      ...
      "Clipping cleanup from hard surfaces",
      "Weekly, every other week, and single visit service",
    ],
    ...
    points: [
      ...
      ["Ready for storm season", "A steady schedule keeps fast spring and summer growth under control."],
      ["Curb appeal that lasts", "Edging and cleanup keep the whole property looking finished."],
    ],
  },
  {
    slug: "garden-beds",
    ...
    included: [
      ...
      "Fresh mulch installation and finishing touches",
    ...
    points: [
      ...
      ["Mulch that protects moisture", "The right depth protects roots and slows moisture loss through summer."],
      ["Seasonal refreshes", "We keep beds presentable from spring color through fall cleanup."],
    ],
  },
  {
    slug: "yard-cleanup",
    eyebrow: "Cleanup and removal",
    title: "Yard Cleanup & Debris Removal",
    shortTitle: "Yard Cleanup",
    image: "/images/work/cleanup-after.jpg",
    description: "Leaves, limbs, storm debris, and yard waste cleared and removed completely, not moved to the curb.",
    included: [
      "Leaf, limb, and yard debris removal",
      "Storm cleanup and fallen branch removal",
      "Rental and move out property cleanups",
      "Seasonal spring and fall reset visits",
      "Final rake, surface cleanup, and debris removal",
    ],
    who: "Busy homeowners, property managers, and businesses facing more cleanup than a trash cart can handle.",
    why: "We bring the equipment, labor, and hauling capacity to clear the mess in one visit.",
    ...
    points: [
      ...
      ["Complete debris removal", "Debris leaves with us instead of becoming your next problem."],
  ...
  },
  {
    ...
    included: [
      ...
      "Overgrown lot and back acreage cleanup",
      "Small tree and eastern redcedar removal",
      "Cut material gathering and removal",
    ],
    who: "Landowners, farms, businesses, and homeowners reclaiming overgrown areas with difficult access.",
    ...
    localBody: "Eastern redcedar, volunteer trees, and rapidly growing brush can swallow fence lines quickly. Early, clean removal protects access and usability.",
    points: [
